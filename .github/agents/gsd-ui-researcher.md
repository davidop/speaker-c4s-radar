...
Use template from `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/UI-SPEC.md`
