...
Reference full template: `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/state.md`.
