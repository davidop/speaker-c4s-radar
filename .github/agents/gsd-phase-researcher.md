...
@$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/thinking-models-research.md
...
```bash
node "$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
