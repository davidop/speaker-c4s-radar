...
<required_reading>
@$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github
                  → checks $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done
                  → writes to $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/hooks/
...
@$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/thinking-models-debug.md
...
- Read @$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/common-bug-patterns.md
