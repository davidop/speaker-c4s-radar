...
<!-- For checkpoint task examples and patterns, see @$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/checkpoints.md -->
...
See `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/workflows/verify-phase.md` for verification logic.
