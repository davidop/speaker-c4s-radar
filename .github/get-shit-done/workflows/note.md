...
- **Global scope**: `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/notes/`)
...
2. Glob `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/notes/*.md` (if directory exists) — global notes
...
Global ($HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/notes/):
...
2. **No `.planning/`**: Falls back to global `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/notes/` — works in any directory
