...
@$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/references/spidr-splitting.md`. Briefly:
