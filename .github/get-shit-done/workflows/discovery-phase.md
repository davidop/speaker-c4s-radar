...
See $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/discovery.md
...
Use $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/discovery.md.
