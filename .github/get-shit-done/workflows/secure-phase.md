...
```
Agent(
  prompt="Read $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/templates/SECURITY.md`
