...
INSTALL_JS_GLOBAL="$HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node $HOME/work/speaker-c4s-radar/speaker-c4s-radar/.github/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
